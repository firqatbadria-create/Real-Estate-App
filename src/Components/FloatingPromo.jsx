    ...
    <div className="flex items-center justify-center gap-2">
      {people.map((p, idx) => (
        <motion.div
          ...
          className={cn(
            // smaller avatars
            "h-11 w-11 rounded-full ring-4 ring-white shadow-md",
            p.bg
          )}
          title="Customer"
        />
    ...
    <section className="bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14 sm:py-20">
        ...
        >
          {/* Card 1 (Dark) */}
          <CardShell
            className="bg-[#0b0f14] text-white min-h-[320px]"
            delay={0.05}
          >
          ...
          {/* Card 2 (Light gray) */}
          <CardShell
            className="bg-slate-100 text-slate-900 min-h-[320px]"
            delay={0.12}
          >
          ...
          {/* Card 3 (Blue rating) */}
          <CardShell
            className="bg-[#3192f6] text-white min-h-[320px]"
            delay={0.18}
          >
            ...
            <div className="relative p-6 flex flex-col h-full">
              ...
              <div className="mt-10 flex items-center justify-between px-4">
                ...
                <motion.span
                  whileHover={{ y: -2 }}
                  className="rounded-full bg-white px-4 py-2 text-sm font-semibold text-slate-900 shadow inline-flex items-center gap-2"
                >
